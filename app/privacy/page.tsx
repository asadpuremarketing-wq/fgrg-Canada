...
export const metadata: Metadata = pageMetadata({
  title: pagesContent.privacy.title,
  description: pagesContent.privacy.subtitle,
  path: "/privacy",
});

export default function PrivacyPage() {
  const page = pagesContent.privacy;
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Privacy Policy", url: `${siteConfig.siteUrl}/privacy` },
        ]}
      />
      <PageShell
        title={page.title}
        ...
        visualAlt="Abstract privacy and governance visual"
      >
