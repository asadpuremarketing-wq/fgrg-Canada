    ...
    <article className="space-y-8 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Donate via CanadaHelps", url: `${siteConfig.siteUrl}/donate/canadahelps` },
        ]}
      />
      <PageHeader
        title="Donate via CanadaHelps"
      ...
      >
        <div className="flex items-center gap-5">
          <div className="h-14 w-14 rounded-2xl flex items-center justify-center shrink-0" style={{ background: "rgba(25,175,175,0.1)" }}>
            <Heart size={28} style={{ color: "#19AFAF" }} />
          </div>
          <div>
            <h2 className="!text-xl" style={{ color: "#0e507b" }}>CanadaHelps Platform</h2>
            <p className="text-sm mt-1" style={{ color: "#64748b" }}>Canada&apos;s largest charitable giving platform</p>
          </div>
        </div>
